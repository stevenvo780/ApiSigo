...
const sigoService_1 = require("@/services/sigoService");
...
describe('FacturaService', () => {
    let facturaService;
    const mockSigoService = sigoService_1.sigoService;
    const mockWebhookService = webhookService_1.webhookService;
    beforeEach(() => {
        facturaService = new facturaService_1.FacturaService();
        jest.clearAllMocks();
    });
    describe('crearFacturaDesdeWebhook', () => {
        ...
        it('debería crear una factura exitosamente desde webhook', async () => {
            ...
            expect(mockSigoService.createInvoice).toHaveBeenCalledWith(expect.objectContaining({
    ...
    describe('calcularResumen', () => {
        it('debería calcular correctamente el resumen de totales', () => {
            ...
            const resumen = facturaService.calcularResumen(items);
...
//# sourceMappingURL=facturaService.test.js.map